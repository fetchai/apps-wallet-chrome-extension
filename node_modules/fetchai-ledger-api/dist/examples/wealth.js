...
async function main() {
  ...
  _utils.logger.info(`Balance before wealth: ${balance}`);

  const entity = new _entity.Entity(Buffer.from('2ff324b9d3367b160069ec67260959b4955ab519426603b5e59d5990128163f3', 'hex'));
  const j = await api.wealth(entity, 1000);

  _utils.logger.info('wealth after', j);
}

main(); // Note: use this for testing purpose
